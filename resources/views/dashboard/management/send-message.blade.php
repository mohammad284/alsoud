    ...
    <div class="content-wrapper">
        ...
        <div class="container-fluid">
            ...
            <div class="col-md-3">
                ...
                <div class="card-body p-0">
                    ...
                    <li class="nav-item active">
                        <a href="/admin/managementMessage" class="nav-link">
                        <i class="fas fa-inbox"></i> All Messages
                        <span class="badge bg-danger float-right">{{$count}}</span>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a href="/admin/sendTemplate" class="nav-link active">
            ...
            <div class="card card-primary card-outline">
              ...
              <!-- /.card-header -->
              <form class="forms-sample"  method="POST" action="/admin/sendMessage">
              @csrf
                <div class="card-body">
